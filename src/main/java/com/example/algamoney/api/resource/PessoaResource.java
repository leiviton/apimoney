...
public class PessoaResource {
	...
	@GetMapping("/{codigo}")
	public ResponseEntity<Pessoa> edit(@PathVariable Long codigo)
	{
		Pessoa pessoa = pessoaService.edit(codigo);
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void inativarPessoa(@PathVariable Long codigo, @RequestBody Boolean ativo)
	{
		pessoaService.inativarPessoa(codigo,ativo);
	}
}
